...
switch ($origenDatos) {
    ...
    case (0):
        ...
        $update = "UPDATE padronelectoral SET municipio='$municipio', parroquia='$parroquia', ubch='$ubch', comunidad='$comunidad', voto='$voto', registradopor='$ap', telefono='$telefono', cv='$cv', act='1' WHERE cedula='$ci'";
    ...
    case (1):
        $update = "UPDATE padronelectoral SET municipio='$municipio', parroquia='$parroquia', ubch='$ubch', comunidad='$comunidad', voto='$voto', registradopor='$ap', origenDatos='0', act='1' WHERE cedula='$ci'";
        $result = mysqli_query($conexion, $update);
        if ($result) {

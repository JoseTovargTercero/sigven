...
header( 'Content-Disposition: attachment; filename=Estructuras de UBCH del Estado - SIGVEN - '.date('Y_m_d h-i a').' .xls' );
...
<p class='titulo'>Estructuras de UBCH del Estado<br><br></p>
...
$carnetizado = $base->prepare($sql);
    ...
    $query22="SELECT estructuraubch.nombre, estructuraubch.cedula, estructuraubch.cargo, estructuraubch.telefono, estructuraubch.cv, estructuraubch.cargo, pais.name1, continente.name2
    FROM estructuraubch 

...
header( 'Content-Disposition: attachment; filename=Estructuras de RAAS del Estado - SIGVEN - '.date('Y_m_d h-i a').' .xls' );
...
<p class='titulo'>Estructuras RAAS del Estado<br><br></p>
        ...
        <tr>
            ...
            <th class="header">Consejo Comunal</th>
...
$carnetizado = $base->prepare($sql);
    ...
    $query22="SELECT estructuraraas.nombre, ciudad.name, estructuraraas.cedula, estructuraraas.cargo, estructuraraas.telefono, estructuraraas.cv, estructuraraas.cargo, pais.name1, continente.name2
    FROM estructuraraas 
    ...
    ORDER BY `parroquia`,`ubch`,`id_propio`";

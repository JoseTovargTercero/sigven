...
<head>
  ...
  <script>
    ...
    $(function() {
      ...
      var li = $('.index');
      li.text('Registros');
      h6.text('Registro de Consejo Comunal');
...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    ...
    <div class="container-fluid py-4">
      <form class="row" role="form" action="../configurar/create/nueva_comunidad.php" method="POST">
        <div class="col-lg-6">
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              ...
              <p style="color: #c5c5c5; margin-top: -15px;     opacity: 0.5 !important;">UBCH asociada</p>
        ...
        <div class="col-lg-6">
          <div class="card h-100  cblur shadow-blu ">
            <div class="card-header pb-0 p-3">
              <h6 class="mb-0">Información del Consejo Comunal</h6>
            </div>
            <div class=" p-3 row">

              <p style="color: #c5c5c5; margin-top: -15px;  opacity: 0.5 !important;">Datos del Consejo Comunal</p>

              
              <div class="mb-3">
                <label>Nombre</label>
                <input  type="text" id="nombre" name="nombre" class="form-control" placeholder="Nombre del Consejo Comunal">
              </div>
  ...
  <?php
$varCount = 0;
$query5555 = "SELECT continente.name2, pais.name1, mcp.mcp, ciudad.id, ciudad.name FROM `ciudad`
LEFT JOIN `pais` ON pais.id=ciudad.pais_id 
LEFT JOIN `continente` ON continente.id=pais.continente_id 
LEFT JOIN `mcp` ON mcp.id=continente.mcp_id 
ORDER BY ciudad.pais_id";
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="card h-100  cblur shadow-blu" style="box-shadow: 0 -20px 27px 0 rgb(0 0 0 / 5%);">
          ...
          <div class="card-body p-3 ">
            <form action="../configurar/update/nueva_comunidad.php" method="post" class="row"> 
          ...
          <input style="margin-bottom: 16px;" readonly name="id" id="id" class="form-control" required hidden value="'.$fila9855['id'].'">
                ...
                <div class="col-lg-3">
                  <label>UBCH</label>
                  <input style="margin-bottom: 16px;" class="form-control" required  value="'.$fila9855['name1'].'">
                </div>

        
                <div class="col-lg-3">
                <label>Comunidad</label>
                <input style="margin-bottom: 16px;"  name="nombre" id="nombre" class="form-control"   value="'.$fila9855['name'].'">
              </div>
...
$ubch = ucwords(mb_strtolower($fila9855['name1']));
...
$datos .= '
   ...
   <td class=tablat>' . $cv . '</td>
   <td class=tablat>' . ucwords(mb_strtolower($fila9855['name'])) . '</td>
              ...
              <table class="table align-items-center mb-0 ">
                <thead>
                  <tr>
                    ...
                    <th style="padding: 10px !important">Concejo Comunal</th>
                    <th style="padding: 10px !important"></th>
                  </tr>
                </thead>
                <tbody>

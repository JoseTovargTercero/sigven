...
if ($_SESSION['comunidad_padron'] != "") {
  ...
  $municipio = $_SESSION['municipio_padron'];
  $parroquia = $_SESSION['parroquia_padron'];
  $centrodev = $_SESSION['ubch_padron'];
  $comunidad = $_SESSION['comunidad_padron'];
  $calle = $_SESSION['calle_padron'];
...
<meta http-equiv='X-UA-Compatible' content='IE=edge'>
  ...
  <script>
    ...
    function obtener_registros2(callee, comunidadd) {
      $.ajax({
          url: 'ajaxConsultas/consulta_registro_padron_tabla.php',
          type: 'POST',
          dataType: 'html',
          data: {
            callee: callee,
    ...
    function obtener_registros3(rep3) {
      $.ajax({
          url: 'ajaxConsultas/consulta_registro_padron_jefesCalle.php',
          type: 'POST',
          dataType: 'html',
          data: {
            rep3: rep3
...
<body class="g-sidenav-show bg-gray-100">
  ...
  <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
    ...
    <div class="container-fluid py-4">
      <form class="row" role="form" action="../configurar/create/padron.php" method="POST">
        <div class="col-lg-4">

      ...
      <div class="col-lg-12">
        <div class="card h-100  cblur shadow-blu" style="box-shadow: 0 -20px 27px 0 rgb(0 0 0 / 5%);">
          ...
          <div class="card-body p-3 ">
            <form action="../configurar/update/ubch.php" method="post" class="row"> 
...
<div class="container-fluid py-4">
 <div class="row">
   <div class="col-lg-12">
     <div class="card h-100  cblur shadow-blu" style="box-shadow: 0 -20px 27px 0 rgb(0 0 0 / 5%);">
      <div class="card-header pb-0 p-3">
        <h6 class="mb-0">Estructura de la UBCH</h6>
      </div>
...
<?php
$varCount = 0;
$query5555 = "SELECT * FROM `estructuraubch` WHERE ubch=$ubch_ubch ORDER BY id_propio";
$buscarAlumnos5555 = $conexion->query($query5555);
if ($buscarAlumnos5555->num_rows > 0) {
  while ($fila9855 = $buscarAlumnos5555->fetch_assoc()) {

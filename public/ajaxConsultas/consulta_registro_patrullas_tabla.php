...
?>
  ...
  $query55 = "SELECT * FROM `estructurapatrulla` WHERE calle='$q' AND comunidad='$q2' ORDER BY calle";
      ...
      <div class="col-lg-12">
        <div class="card h-100  cblur shadow-blu" style="box-shadow: 0 -20px 27px 0 rgb(0 0 0 / 5%);">
          ...
          <div class="card-body p-3 ">
            <form action="../configurar/update/patrullas.php" method="post" class="row"> 
...
<a style="display: none" id="lock_' . $fila9855['id'] . '" href="../configurar/delete/patrullas.php?id=' . $fila9855['id'] . '&nombre=' . $fila9855['nombre'] . '&cedula=' . $fila9855['cedula'] . '&cargo=' . $fila9855['cargo'] . '"><i class="line icon-user-unfollow"></i></a>
</td>
</tr>
...
<?php
      $varCount = 0;
      $query5555 = "SELECT * FROM `estructurapatrulla` WHERE comunidad='$comunidad' AND calle='$calle_patr'";
      ...
      <div class="container-fluid py-4">
        <div class="row">
          <div class="col-lg-12">
            <div class="card h-100  cblur shadow-blu" style="box-shadow: 0 -20px 27px 0 rgb(0 0 0 / 5%);">
              <div class="card-header pb-0 p-3">
                <h6 class="mb-0">Patrulla Territorial de la <?php echo $calle_patr ?></h6>
              </div>
              <div class="card-body p-3 row">
                <div class="table-responsive p-0">
                  <table class="table align-items-center mb-0 ">
